...
public class CliToolConfig {
    ...
    public static class Builder {
        //@songzhx  para1 ="start1" para2= Start.class
        ...
        //@songzhx   optionBuilder("d", "daemonize")
        //@songzhx    Option.builder("D").argName("property=value").valueSeparator('=').numberOfArgs(2)
    ...
    public static class Cmd {
        ...
        public static class Builder {
            ...
            //@songzhx para1="start" para2= Start.class
