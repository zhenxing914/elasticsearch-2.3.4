...
final class BootstrapCLIParser extends CliTool {
    //@songzhx   .config() => CliToolConfig.Build
    //@songzhx   CliToolConfig.Build.cmds()
    ...
    static class Start extends CliTool.Command {
        ...
        //@songzhx CMD is object   cmd (define in CliTool) inherited from  CliToolConfig  is CliToolConfig.Build.cmd（）
        private static final CliToolConfig.Cmd CMD = cmd(NAME, Start.class) // @songzhx create a CliToolConfig.Cmd.Build
                .options(                                                   //@songzhenx create a Cmd.Build
